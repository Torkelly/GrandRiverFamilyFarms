...
<div id="navMain">
  <ul class="back">
    ...
    <li><a href = "https://www.grandriverfamilyfarms.com/index.php?main_page=page&id=2">Gallery</a></li>
...
<?php if ($_SESSION['cart']->count_contents() != 0) { ?>
    <li><a href="<?php echo zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL'); ?>"><?php echo HEADER_TITLE_CART_CONTENTS; ?></a></li>
    <li><a class="blue" href="<?php echo zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL'); ?>"><?php echo HEADER_TITLE_CHECKOUT; ?></a></li>
<?php }?>

<?php
    if (zen_is_logged_in() && !zen_in_guest_checkout()) {
?>
    <li class="last"><a href="<?php echo zen_href_link(FILENAME_LOGOFF, '', 'SSL'); ?>"><?php echo HEADER_TITLE_LOGOFF; ?></a></li>
<?php } else {} ?>
