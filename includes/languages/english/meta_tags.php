...
// page title
define('TITLE', 'Local & family owned farm');

// Site Tagline
define('SITE_TAGLINE', 'selling organics in the Thayer area');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'Ecological respect and dignity are the foundation of humane animal care and regenerative farming practices at Grand River Family Farms. Pastures and timbers are holistically managed, free from industrial agriculture practices that damage the ecosystem and result in chemical-laden, nutritionally deficient food. Livestock are raised outdoors, surrounded by fresh air and with ample freedom to forage and roam. Pasture raised poultry are free to move about unrestricted, with unlimited access to healthy fresh greens every day. Pigs root and explore as nature intended, unconfined in open timber paddocks.');

// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'Grand River Family Farms');
  define('HOME_PAGE_META_KEYWORDS', 'farm, iowa, ia, us, united, states, shop, online, ecommerce, shopping, store, local, rural, pig, hog, chicken, duck, pork, beef, organic, eggs, nature, natural, poultry, farmer, regenerative, farming, agriculture, meat, grown, pasture, raised, family, owned, small, business, community, sustainable, commercial, animal, usda, approved');
