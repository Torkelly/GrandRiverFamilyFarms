...
define('ENTRY_NAME', 'Full Name: Vernon & Patti Kelly');
define('ENTRY_EMAIL', 'Email Address: grandriverfamilyfarms@gmail.com');
define('ENTRY_TELEPHONE', 'Telephone Number: (515)-720-4927');
define('ENTRY_ENQUIRY', 'Message: Thank you! Please allow 3-5 business days for a reply.');
